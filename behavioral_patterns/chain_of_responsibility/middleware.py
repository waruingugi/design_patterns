...
class AuthenticationMiddleware(Middleware):
    ...
    def handle_request(self, request):
        """
        Handle authentication or pass to the next middlweware in the chain.
...
class LoggingMiddleware(Middleware):
    ...
    >>> logging_middlware.handle_request({"user": "username", "data": "valid_data"})
...
if __name__ == "__main__":
    ...
    print(f"{'*'*50}")
    print("Processing and invalid request")
    print(f"{'*'*50}")
