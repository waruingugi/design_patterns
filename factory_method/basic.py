...
class Localizer(ABC):
    ...
    def localize(self, msg):
        ...
        Args:
            msg (str): The message to be transalted
...
class LocalizerFactory(ABC):
    ...
    This is an abstract class defineing the interface for concrete localizer factories.
    """
...
def main():
    ...
    for msg in message:
        # Translate and pring the messages
        print(f"Message: {msg}")
