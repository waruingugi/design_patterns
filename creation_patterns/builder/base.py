...
class ConcreteBuilderB(Builder):
    """The ConcreteBuilderB class provides specific implementations for building parts of the complec object."""
...
class Client:
    ...
    def construct_product(self, builder):
        """Constructs the product using the provider builder."""
        director = Director()
