...
class NotificationFactory(ABC):
    ...
    Methods:
        ...
        create_psuh_notification(): Abstract method for creating a PushNotification.
    """
...
class FastNotifFactory(NotificationFactory):
    ...
    Methods:
        create_email_notification(): Creates a FastNotif email notification email object.
...
class AbstractSMSNotification(ABC):
    ...
    Methods:
        send(): Abstract method for sendign the SMS notification.
...
class FastNotifPushNotification(AbstractPushNotification):
    ...
    def format_payload(self):
        print("Formating Push Notification payload")
...
class SendBlueSMSNotification(AbstractSMSNotification):
    """Concrete Product for SMS Notification via SendBlue"""
...
def select_notification_factory(provider):
    ...
    Raises:
        ValueError: If an invalid provider names is provided.
    """
