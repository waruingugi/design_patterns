class SingletonMeta(type):
    ...
    Methods:
        __call__(cls, *args, **kwargs): Creates a new instance only if one does already exist.
    ...
    def __call__(cls, *args, **kwargs):
        """
        Create a new instance of the Singleton class if does not already exist.
...
class Singleton(metaclass=SingletonMeta):
    ...
    Here goues our class's business logic without concerning about handling
    the intricacies of the singleton pattern.
